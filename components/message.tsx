                ...
                case "tool-invocation":
                  ...
                  return (
                    <motion.div
                      ...
                      animate={{ y: 0, opacity: 1 }}
                      key={`message-${message.id}-part-${i}`}
                      className="flex flex-col gap-2 p-2 mb-3 text-sm bg-zinc-50 dark:bg-zinc-900 rounded-md border border-zinc-200 dark:border-zinc-800 cursor-pointer"
                    >
                      <DefaultToolPlaceholder 
